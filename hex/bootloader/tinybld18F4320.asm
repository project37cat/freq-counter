	radix DEC
	LIST      P=18F4520	; change also: Configure->SelectDevice from Mplab 
xtal EQU 48000000		; you may want to change: _XT_OSC_1H  _HS_OSC_1H  _HSPLL_OSC_1H
baud EQU 115200			; standard TinyBld baud rates: 115200 or 19200
	...
	;********************************************************************
	;	Updated to 18F4320 by Jay.slovak 2005, jay.slovak@zoznam.sk
...
BEGIN_NORMAL		ORG	0x0004	;Place "GOTO START" @ 0004h in your application
